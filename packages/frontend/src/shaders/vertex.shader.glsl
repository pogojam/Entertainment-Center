...
void main() {
  ...
  vec3 distortion =
      vec3(3) * curlNoise(vec3(position.x * frequency * shift + sin(time),
                               position.y, position.z));
  // pos.y =
  //     pos.y +
  //     ((sin(uv.x * 3.1415926535897932384626433832795) * time * 5.0) * 0.125);

  // pos.x =
  //     pos.x +
  //     ((sin(uv.y * 3.1415926535897932384626433832795) * time * 5.0) * 0.125)
  //     + crossAxis;

  pos.z += distortion.x * sin(time);
